# -*- coding: utf-8 -*-
"""Lista los casos de un plan de tokmd, solo lectura. Para armar el brief de
QA con los summaries exactos en vez de adivinarlos.

Uso: por stdin, {"password": "...", "plan": "PBI-002 - Tokenizador Claude"}
"""
import json
import os
import sys
...
def main():
    ...
    for caso in sorted(casos, key=lambda c: c["id"]):
        print(json.dumps({"id": caso["id"], "summary": caso["summary"], "text": caso["text"]}))
